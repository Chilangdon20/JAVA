...
public class TallerMecanico extends JFrame {
	...
	public void inicializaValores() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if((taller.getMecanico1().getAutos()==null || taller.getMecanico1().getAutos().size()==0)
					...
					JOptionPane.showMessageDialog(contentPane, "Autos Reparados en el mes Octubre del año actual: "+
		...
		JButton btnNewButton_1 = new JButton("Comisión por Auto");
		...
		JButton btnNewButton_4 = new JButton("Autos en Reparación");
		...
		JButton btnNewButton_5 = new JButton("Salario + Comisión");
		btnNewButton_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if((taller.getMecanico1().getAutos()==null || taller.getMecanico1().getAutos().size()==0)
					...
					JOptionPane.showMessageDialog(contentPane, sdf.format(new Date())+"\nSalario del mes de octubre del año 2020 para "
